...
INSERT INTO `Flight_data` VALUES (1,10000,135,450,52.22970,21.01220,'FL1'),(2,110000,180,520,52.35340,21.00320,'LH233');
...
CREATE TABLE `Flights` (
  ...
  `status` enum('SCHEDULED','WAITING','AIRBORNE','TAKE OFF','LANDING','FINISHED','CANCELED') NOT NULL DEFAULT 'SCHEDULED',
...
CREATE TABLE `Taxiways` (
  `id` varchar(8) NOT NULL,
  `is_available` tinyint(1) NOT NULL DEFAULT '1',
  `status` enum('CLOSED','OCCUPIED','EMPTY') NOT NULL DEFAULT 'EMPTY',
  `flight_id` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uc_Flight_id` (`flight_id`),
  UNIQUE KEY `flight_id` (`flight_id`),
...
INSERT INTO `Taxiways` VALUES ('TW1',1,'EMPTY','FL1');
...
CREATE TABLE `Terminals` (
  ...
  `status` enum('CLOSED','OPEN','EMPTY','FULL') NOT NULL DEFAULT 'EMPTY',
  `flight_id` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uc_Flight_id` (`flight_id`),
  UNIQUE KEY `flight_id` (`flight_id`)
...
INSERT INTO `Terminals` VALUES (1,1,1,'EMPTY','FL1'),(5,1,1,'EMPTY','FL2');
...
CREATE TABLE `Tickets` (
  ...
  `status` enum('PURCHASED','EXPIRED','USED') NOT NULL DEFAULT 'PURCHASED',
  `Users_uid` int NOT NULL,
  `Flight_id` varchar(10) NOT NULL,
  `Gates_id` int NOT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `Tickets` VALUES (1,'2024-04-10 10:00:00','2024-04-10 12:00:00','Ekonomiczna',15,'PURCHASED',6,'FL1',1);
...
-- Dump completed on 2024-05-08 21:11:32
