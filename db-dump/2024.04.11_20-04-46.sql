...
CREATE TABLE `Contact_info` (
  ...
  `krs` int DEFAULT NULL,
  `phone_inf` varchar(45) DEFAULT NULL,
  `phone_central` varchar(45) DEFAULT NULL,
  `email_pr` varchar(45) DEFAULT NULL,
  `email_marketing` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`name`),
...
INSERT INTO `Contact_info` VALUES ('Port lotniczy','ul. KrÃ³lowej Jadwigi',5,'33-300','Nowy SÄ…cz',733911,123234234,'+48 123 234 234','+48 123 234 234','biuro.lotniska@op.pl','marketing.lotniska@op.pl');
...
INSERT INTO `Flight` VALUES ('EJU 4668','AIRBORNE','EasyJet','PARYÅ» (CDG)','2024-05-01 16:50:00','2024-05-01 15:50:00','ABC231'),('FL1','STARTUJE','LOT','Warszawa','2024-04-10 12:00:00','2024-04-10 10:00:00','ABC123'),('FR 1902','AIRBORNE','Ryanair','DUBLIN (DUB)','2024-05-01 17:30:00','2024-05-01 17:30:00','ABC236'),('FR 3036','AIRBORNE','Ryanair','BARCELONA (BCN)','2024-05-01 17:25:00','2024-05-01 17:25:00','ABC235'),('KL 1996','AIRBORNE','KLM','AMSTERDAM (AMS)','2024-05-01 17:00:00','2024-05-01 17:00:00','ABC233'),('KL 1998','AIRBORNE','KLM','FRANKFURT (FRA)','2024-05-01 17:45:00','2024-05-01 17:45:00','ABC237'),('LH 1623','AIRBORNE','Lufthansa','MONACHIUM (MUC)','2024-05-01 17:20:00','2024-05-01 17:20:00','ABC234'),('LH233','WAITING','Lufthansa','Budapeszt','2024-04-11 18:25:00','2024-04-11 16:15:00','ABC231'),('W6 5047','AIRBORNE','WizzAir','BARCELONA (BCN)','2024-05-01 16:40:00','2024-05-01 16:40:00','ABC232');
...
-- Dump completed on 2024-04-11 18:04:51
