    ...
    <div style={tabelkaStyle}>
      ...
      <div style={trescStyle}>
        <p>
          ...
          possimus est perferendis ea. Lorem ipsum, dolor sit amet consectetur
          adipisicing elit. Tempora similique dolor suscipit assumenda magni
          aperiam et soluta ab rerum! Ex minima consequuntur voluptatibus libero
          eius? Labore, cum. Sunt, ea expedita.
        </p>
      </div>
    </div>
  );
